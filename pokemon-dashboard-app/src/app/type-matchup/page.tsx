...
const typeIcons: Record<PokemonType, React.ReactNode> = {
  ...
  fire: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
      <path d="M12 2c-1 4-5 6-5 10a5 5 0 0010 0c0-4-4-6-5-10z" />
    </svg>
  ),
  water: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
      <path d="M12 2C8 8 4 11 4 14.5a8 8 0 0016 0C20 11 16 8 12 2z" />
    </svg>
  ),
  electric: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  grass: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
      <path d="M12 22c-4 0-8-3-8-8 0-5 4-10 8-12 4 2 8 7 8 12 0 5-4 8-8 8z" />
    </svg>
  ),
  ice: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  fighting: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
      <path d="M8 5v5H3v4h5v5h4v-5h5v-4h-5V5z" />
    </svg>
  ),
  poison: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
      ...
      <circle cx="15" cy="10" r="2" fill="currentColor" opacity="0.4" />
    </svg>
  ),
  ground: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
      <path d="M3 18h18v2H3zm0-4h12v2H3zm0-4h18v2H3zm0-4h12v2H3z" opacity="0.7" />
    </svg>
  ),
  flying: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
      <path d="M22 6c-2 1-3.5 1.5-5 2-1.5-1-3-2-5-2-3 0-5 2-6 4 3-1 5.5 0 7 1 1.5-2 4-3 7-3-2 1-3.5 2.5-4 4l-3 1 2 1 1 3 1-3 2-1-3-1c.5-1.5 2-3 4-4z" />
    </svg>
  ),
  psychic: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
      ...
      <path
        d="M12 2a10 10 0 0110 10h-2a8 8 0 00-8-8zM2 12a10 10 0 0110-10v2a8 8 0 00-8 8z"
        opacity="0.6"
      />
    </svg>
  ),
  ...
  rock: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
      <path d="M6 18l-3-6 4-6h10l4 6-3 6z" opacity="0.7" />
    </svg>
  ),
  ghost: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
      <path d="M12 2a8 8 0 00-8 8v8l2-2 2 2 2-2 2 2 2-2 2 2v-8a8 8 0 00-8-8zm-3 7a1 1 0 110-2 1 1 0 010 2zm6 0a1 1 0 110-2 1 1 0 010 2z" />
    </svg>
  ),
  dragon: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
      <path d="M12 2C8 4 4 8 4 12c0 3 2 6 5 7l3-2 3 2c3-1 5-4 5-7 0-4-4-8-8-10z" />
    </svg>
  ),
  dark: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  steel: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
      <path d="M12 2l8 4v6c0 5.5-3.5 9.7-8 11-4.5-1.3-8-5.5-8-11V6z" opacity="0.7" />
    </svg>
  ),
  fairy: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
      <path d="M12 2l2.4 4.8L19 7.5l-3.5 3.4.8 4.9L12 13.3l-4.3 2.5.8-4.9L5 7.5l4.6-.7z" />
    </svg>
  ),
}
    ...
    >
      <div className="flex items-center justify-center gap-4 mb-4">
        <div className="flex items-center gap-2 text-sm text-white/50">
          <span style={{ color: typeColorMap[attackingType] }}>
            {attackingIcons(attackingType)}
          </span>
  ...
  return (
    <div className="space-y-3">
      <h3 className="text-xs uppercase tracking-widest text-white/40 font-[family-name:var(--font-pixel)]">
        All Attacking Types vs{' '}
        {defendingTypes.map((t) => t.charAt(0).toUpperCase() + t.slice(1)).join('/')}
      </h3>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      <div className="text-center mb-8 sm:mb-10">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2 tracking-tight">
          Type{' '}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--type-dragon)] to-[var(--type-fairy)]">
            Matchup
          </span>{' '}
          Calculator
        </h1>
        <p className="text-white/40 text-sm max-w-lg mx-auto">
          Select an attacking type and defending type(s) to calculate effectiveness. Dual-type
          defenders multiply resistances.
        </p>
      </div>
      ...
      {defendingTypes.length > 0 && (
        <div className="space-y-6 animate-[slide-in_0.3s_ease-out]">
          <EffectivenessBreakdown attackingType={attackingType} defendingTypes={defendingTypes} />

          <div className="glass rounded-xl p-5">
            <EffectivenessSummary attackingType={attackingType} defendingTypes={defendingTypes} />
          </div>
        </div>
      )}
      ...
      {defendingTypes.length === 0 && (
        <div className="glass rounded-xl p-12 text-center">
          ...
          <p className="text-white/25 text-xs mt-1">Click on type cards in the defending column</p>
        </div>
      )}
    </div>
  )
